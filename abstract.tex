...
The challenge for adding CV to QMC is that the optimal control variate coefficient for QMC is generally not the same as that for MC. 
Here we propose a method for implementing CV in a guaranteed adaptive QMC algorithm. 
